...
function add(a,b){
 ...
 //hm maybe I shouldn't reverse. During adding I basically just want to put the first pieces together.
    ...
    function add(arrA, arrB){
        ...
        if (arrA<arrB){
            shortestLength = arrA.length;
        } else{
            shortestLength = arrB.length;
        }
...
add('1823172964260263830982280609675150766951754355882242391698277783797094232179652457248777050585906182180138262963360272327', '32179652457248777050585906182180138262963360272327');
