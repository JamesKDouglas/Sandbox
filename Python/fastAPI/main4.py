...
# It also takes the filename from the request route rather than the body.
...
@app.post("/uploadfile/{filename}&filter_param={filter_param}")
async def upload_file(file: UploadFile = File(...), filter_param: str = "", filename: str = ""):
