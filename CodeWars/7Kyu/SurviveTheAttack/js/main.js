...
//   console.log("shortest:",shortest);
  ...
  //Subtract values. 
  //Don't mutate, just make new arrays.
    newAttackers[i] = attackers[i]-defenders[i];
    newDefenders[i] = defenders[i]-attackers[i];
  }
  newAttackers = newAttackers.filter(el => el>0);
  newDefenders = newDefenders.filter(el => el>0);
